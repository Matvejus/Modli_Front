...
interface EnergyImpactsProps {
  gowns: Gown[]
}

const EnergyImpacts = ({ gowns }: EnergyImpactsProps) => {
  ...
  const chartData = [
    ...
    { name: 'Energy', ...gowns.reduce((acc, gown) => ({ ...acc, [gown.name]: gown.emission_impacts.Energy.toFixed(2) }), {}) },
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <YAxis 
                tick={{ fontSize: 12 }} 
                width={50}
                label={{ value: 'MJ-eq', angle: -90, position: 'insideLeft' }}
              />
              <Tooltip />
